...
public class SelfTest extends javax.swing.JDialog {
    ...
    void cmd(String cmdstr) {
        ...
        if(this.selfTest_step==11){
            this.appendToPane(this.tp1, " "+cmdstr, Color.YELLOW);
        ...
        if (cla.selfTest_tim == cla.selfTest_nextTime) {
            switch (cla.selfTest_step) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    if (Phone6in1.scla.sock0_rxed_f == 1) {
                        cla.appendToPane(cla.tp1, "成功!\n", Color.GREEN);
                    } else {
                        cla.appendToPane(cla.tp1, "失敗!!!\n", Color.RED);
                    }
                    cla.appendToPane(cla.tp1, "S0P0 通道測試 ==> ", Color.YELLOW);
                    cla.selfTest_nextTime += 30;
                    cla.selfTest_step++;
                    break;
                case 3:
                    if (Phone6in1.scla.sock0p0_rxed_f == 1) {
                        cla.appendToPane(cla.tp1, "成功!\n", Color.GREEN);
                    } else {
                        cla.appendToPane(cla.tp1, "失敗!!!\n", Color.RED);
                    }
                    cla.appendToPane(cla.tp1, "S0P1 通道測試 ==> ", Color.YELLOW);
                    cla.selfTest_nextTime += 10;
                    cla.selfTest_step++;
                    break;
                case 4:
                    if (Phone6in1.scla.sock0p1_rxed_f == 1) {
                        cla.appendToPane(cla.tp1, "成功!\n", Color.GREEN);
                    } else {
                        cla.appendToPane(cla.tp1, "失敗!!!\n", Color.RED);
                    }
                    cla.appendToPane(cla.tp1, "S0P2 通道測試 ==> ", Color.YELLOW);
                    cla.selfTest_nextTime += 10;
                    cla.selfTest_step++;
                    break;
                    
                case 5:
                    if (Phone6in1.scla.sock0p2_rxed_f == 1) {
                        cla.appendToPane(cla.tp1, "成功!\n", Color.GREEN);
                    } else {
                        cla.appendToPane(cla.tp1, "失敗!!!\n", Color.RED);
                    }
                    cla.appendToPane(cla.tp1, "S0P3 通道測試 ==> ", Color.YELLOW);
                    cla.selfTest_nextTime += 10;
                    cla.selfTest_step++;
                    break;
                    
                case 6:
                    if (Phone6in1.scla.sock0p3_rxed_f == 1) {
                        cla.appendToPane(cla.tp1, "成功!\n", Color.GREEN);
                    } else {
                        cla.appendToPane(cla.tp1, "失敗!!!\n", Color.RED);
                    }
                ...
                case 7:
                    ...
                    cla.appendToPane(cla.tp1, "S0P4 通道測試 ==> ", Color.YELLOW);
                    cla.selfTest_nextTime += 10;
                    cla.selfTest_step++;
                    break;
                case 8:
                    if (Phone6in1.scla.sock0p4_rxed_f == 1) {
                        cla.appendToPane(cla.tp1, "成功!\n", Color.GREEN);
                    } else {
                        cla.appendToPane(cla.tp1, "失敗!!!\n", Color.RED);
                    }
                    ...
                    cla.appendToPane(cla.tp1, "SIP " + sipIpAddr + " 連線測試 ==> ", Color.YELLOW);
                    Phone6in1.scla.testUart1_f = 0;
                    cla.selfTest_nextTime += 10;
                    cla.selfTest_step++;
                    break;
                    
                case 9:
                    if (Phone6in1.scla.sipmd_ping_f == 0) {
                        cla.appendToPane(cla.tp1, "失敗!!!\n", Color.RED);
                    } else {
                        if (Phone6in1.scla.sipUart_rxed_f == 1 || Phone6in1.scla.sipIp_rxed_f == 1) {
                            cla.appendToPane(cla.tp1, "成功!\n", Color.GREEN);
                        } else {
                            cla.appendToPane(cla.tp1, "失敗!!!\n", Color.RED);
                        }
                    ...
                    String serverIp=Phone6in1.scla.realSipServerIp;
                    cla.appendToPane(cla.tp1, "PBX " + serverIp + " 連線測試 ==> ", Color.YELLOW);
                    cla.selfTest_nextTime += 10;
                    cla.selfTest_step++;
                    cla.err1_f = Lib.ping(serverIp);
                    break;
                case 10:
                    if (cla.err1_f == 0) {
                        cla.appendToPane(cla.tp1, "成功!\n", Color.GREEN);
                    ...
                    cla.appendToPane(cla.tp1, "按鍵測試 按 OK 離開 ==>\n", Color.YELLOW);
                    cla.selfTest_nextTime += 10;
                    cla.selfTest_step++;
                    break;
