        ...
        if (cla.selfTest_tim == cla.selfTest_nextTime) {
            switch (cla.selfTest_step) {
                ...
                case 2:
                    ...
                    cla.appendToPane(cla.tp1, "UARTIO 通道測試 ==> ", Color.YELLOW);
                    cla.selfTest_nextTime += 10;
                    cla.selfTest_step++;
                    break;
                case 3:
                    ...
                    cla.appendToPane(cla.tp1, "USBIO1 通道測試 ==> ", Color.YELLOW);
                    cla.selfTest_nextTime += 10;
                    cla.selfTest_step++;
                    break;
                case 4:
                    ...
                    cla.appendToPane(cla.tp1, "USBIO2 通道測試 ==> ", Color.YELLOW);
                    cla.selfTest_nextTime += 10;
                    cla.selfTest_step++;
                    break;
                case 5:
                    ...
                    cla.appendToPane(cla.tp1, "SWITCH " + GB.switch_ip_str + " 連線測試 ==> ", Color.YELLOW);
                    cla.selfTest_nextTime += 10;
                    cla.selfTest_step++;
                    cla.err1_f = Lib.ping(GB.switch_ip_str);
                case 6:    
                    if (cla.err1_f == 0) {
                        cla.appendToPane(cla.tp1, "成功!\n", Color.GREEN);
                    } else {
                    ...
                    cla.appendToPane(cla.tp1, "SWITCH 封包測試 ==> ", Color.YELLOW);
                    cla.selfTest_nextTime += 10;
                    cla.selfTest_step++;
                    break;
                case 7:
                    if (Phone6in1.scla.switch_rxed_f == 1) {
                        cla.appendToPane(cla.tp1, "成功!\n", Color.GREEN);
                    } else {
                        cla.appendToPane(cla.tp1, "失敗!!!\n", Color.RED);
                    }
                    cla.appendToPane(cla.tp1, "面板 封包測試 ==> ", Color.YELLOW);
                    cla.selfTest_nextTime += 10;
                    cla.selfTest_step++;
                    break;
                case 8:
                    if (Phone6in1.scla.keypad_rxed_f == 1) {
                        cla.appendToPane(cla.tp1, "成功!\n", Color.GREEN);
                    } else {
                        cla.appendToPane(cla.tp1, "失敗!!!\n", Color.RED);
                    }
                    cla.appendToPane(cla.tp1, "SIP 封包測試 ==> ", Color.YELLOW);
                    cla.selfTest_nextTime += 10;
                    cla.selfTest_step++;
                    break;
                case 9:
                    ...
                    cla.appendToPane(cla.tp1, "PBX " + GB.sip_server_ip + " 連線測試 ==> ", Color.YELLOW);
                    cla.selfTest_nextTime += 10;
                    cla.selfTest_step++;
                    cla.err1_f = Lib.ping(GB.sip_server_ip);
                    break;
                case 10:
                    if (cla.err1_f == 0) {
                        cla.appendToPane(cla.tp1, "成功!\n", Color.GREEN);
